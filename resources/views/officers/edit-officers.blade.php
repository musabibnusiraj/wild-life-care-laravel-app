                ...
                <form id="formAuthentication" class="mb-3" action="{{ route('institution.update', $institution->id) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <select id="branch"
                                class="form-control text-capitalize @error('branch') is-invalid @enderror" name="branch">
                                @foreach ($branches as $branch)
                                    <option value="{{ $branch }}" class="text-capitalize"
                                        {{ $institution->branch === $branch ? 'selected' : '' }}>
                                        {{ $branch }}
                                    </option>
                                @endforeach
                            </select>
